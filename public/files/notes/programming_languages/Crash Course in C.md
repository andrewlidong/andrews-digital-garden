...
## A note on the C ecosystem

Most modern languages have a large ecosystem of open-source libraries, and an easy way to use them in your own projects.

C does not. To be fair, it was invented two decades before the Web existed.

There _are_ a lot of libraries written in C. But there is no single package repository, nor a standard way to include the libraries in your project. There isn't even a standard build system.

If you want to compile a single C file into an executable:
